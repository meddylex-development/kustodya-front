...
@Component({
  selector: 'ngx-user-delete-address',
  templateUrl: './user-delete-address.component.html',
  styleUrls: ['./user-delete-address.component.scss'],
})
export class UserDeleteAddressComponent implements OnInit {
  ...
  constructor(
    ...
    protected ref: NbDialogRef<UserDeleteAddressComponent>,
  ) { }
  ...
  fnCancelDeleteAddressUser() {
    this.submitted = false;
    this.dismiss();
  }

  fnDeleteAddressUser(user_data) {
    const self = this;
    self.submitted = true;
    const data_user = [
      {
