...
@Component({
  selector: 'ngx-user-delete-phone-number',
  templateUrl: './user-delete-phone-number.component.html',
  styleUrls: ['./user-delete-phone-number.component.scss'],
})
export class UserDeletePhoneNumberComponent implements OnInit {
  ...
  constructor(
    ...
    protected ref: NbDialogRef<UserDeletePhoneNumberComponent>,
  ) { }
