...
@Component({
  selector: 'ngx-user-add-phone-number',
  templateUrl: './user-add-phone-number.component.html',
  styleUrls: ['./user-add-phone-number.component.scss'],
})
export class UserAddPhoneNumberComponent implements OnInit {
  ...
  constructor(
    ...
    protected ref: NbDialogRef<UserAddPhoneNumberComponent>,
  ) { }
