...
declare var $: any;
@Component({
  selector: 'ngx-origin-qualification',
  templateUrl: './origin-qualification.component.html',
  styleUrls: ['./origin-qualification.component.scss']
})
export class OriginQualificationComponent implements OnInit {
  @Input() group_id: any;
  @Input() report_id: any;
  @Input() state: any;
