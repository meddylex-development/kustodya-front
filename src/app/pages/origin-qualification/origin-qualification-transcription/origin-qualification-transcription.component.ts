...
@Component({
  selector: 'ngx-origin-qualification-transcription',
  templateUrl: './origin-qualification-transcription.component.html',
  styleUrls: ['./origin-qualification-transcription.component.scss']
})
