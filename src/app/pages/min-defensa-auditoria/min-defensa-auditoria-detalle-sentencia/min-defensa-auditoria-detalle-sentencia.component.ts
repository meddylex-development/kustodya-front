...
export class MinDefensaAuditoriaDetalleSentenciaComponent implements OnInit {
  ...
  fnSetDataObject() {
    ...
    self.objectData = {
      ...
      'fechaHechos': { 'texto': self.data_object['fechaHechos'], 'archivoId': 'https://data-learn.000webhostapp.com/data-learn/2019-85700-01-Lista-de-verificacion.pdf', 'nombreArchivo':'2019-85700-01-Lista-de-verificacion.pdf' },
      ...
      'tarjetaProfesional': { 'texto': self.data_object['identificacionApoderado'], 'archivoId': 'https://data-learn.000webhostapp.com/data-learn/2019-85700-01-Lista-de-verificacion.pdf', 'nombreArchivo':'2019-85700-01-Lista-de-verificacion.pdf' },
